...
def main(args):
    ...
    collater = PAMPACollater(tokenizer, encoder.unimol_dictionary, llama_version, args.only_llm)
    ...
    with open(f'pampa/results/re_{save_name}.txt', 'w', encoding='utf-8') as f:
    ...
    with open(f'pampa/results/acc_{save_name}.txt', 'w', encoding='utf-8') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_model_name_or_path', type=str, default='unsloth/Llama-3.1-8B-Instruct')
    parser.add_argument('--tokenizer_path', type=str, default='DongkiKim/Mol-Llama-3.1-8B-Instruct')
    parser.add_argument('--qformer_path', type=str, default=f'{BASE_DIR}/checkpoints/stage2_v2.1/epoch=01.ckpt')
