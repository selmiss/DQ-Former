#!/bin/bash
#
# Preprocess Forward Reaction Prediction Dataset
# 
# This script processes the forward_reaction_prediction dataset from Molecule-oriented_Instructions
# into mol_qa-like JSONL format with multi-molecule support.
#
# Usage:
#   bash scripts/preprocess_forward_reaction.sh
#
...
echo "=================================================="
echo "Preprocessing Forward Reaction Prediction Dataset"
echo "=================================================="
...
echo "=================================================="
echo ""
echo "⚠️  Note: Forward reaction prediction has multiple input molecules"
echo "    (typically 2-10 reactants per example), so processing will be slower"
echo "    than single-molecule datasets."
echo ""
