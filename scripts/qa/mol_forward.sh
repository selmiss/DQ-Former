...
deepspeed --master_port ${MASTER_PORT} --include localhost:${GPUs} \
    ...
    --model_config_path ${BASE_DIR}/configs/qa/mol_forward/model_config.yaml \
    --training_config_path ${BASE_DIR}/configs/qa/mol_forward/training_config.yaml \
    --data_config_path ${BASE_DIR}/configs/qa/mol_forward/data_config_preprocessed.yaml \
