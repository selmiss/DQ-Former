...
# Configuration
export GPUs="5"  # GPU IDs to use for Property Prediction training
...
deepspeed --master_port ${MASTER_PORT} --include localhost:${GPUs} \
    ...
    --model_config_path ${BASE_DIR}/configs/qa/mol_prop/model_config.yaml \
    --training_config_path ${BASE_DIR}/configs/qa/mol_prop/training_config.yaml \
    --data_config_path ${BASE_DIR}/configs/qa/mol_prop/data_config_preprocessed.yaml \
