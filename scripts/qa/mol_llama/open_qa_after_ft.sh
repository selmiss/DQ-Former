...
CUDA_VISIBLE_DEVICES=0 python ${BASE_DIR}/runner/qa_finetuning.py \
    --model_config_path ${BASE_DIR}/configs/qa/mol-llama/open_question_after_ft/model_config.yaml \
    --training_config_path ${BASE_DIR}/configs/qa/mol-llama/open_question_after_ft/training_config.yaml \
    --data_config_path ${BASE_DIR}/configs/qa/mol-llama/open_question_after_ft/data_config_preprocessed.yaml
