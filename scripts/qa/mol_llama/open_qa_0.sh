...
CUDA_VISIBLE_DEVICES=0 python ${BASE_DIR}/runner/qa_finetuning.py \
    --model_config_path ${BASE_DIR}/configs/qa/mol-llama/open_question/model_config.yaml \
    --training_config_path ${BASE_DIR}/configs/qa/mol-llama/open_question/training_config.yaml \
    --data_config_path ${BASE_DIR}/configs/qa/mol-llama/open_question/data_config_preprocessed.yaml
